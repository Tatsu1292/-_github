...
//ゲームプログラムの雛形
//◎下準備
//・リソースファイルに、resource.rcの作成、プログラムの記述
//・ヘッダーファイルに、resource.hの作成(なければ)、プログラムの記述
//・FONTフォルダを、プログラム直下に作成し、TanukiMagic.ttfを中に入れる
//・IMAGEフォルダを、プログラム直下に作成する
//・MUSICフォルダを、プログラム直下に作成する
//・ICOフォルダを、プログラム直下に作成し、game.icoを中に入れる
//☆基本的に、いままでのプログラムを元にしていますが、一部、追加をしています。ご注意下さい。
